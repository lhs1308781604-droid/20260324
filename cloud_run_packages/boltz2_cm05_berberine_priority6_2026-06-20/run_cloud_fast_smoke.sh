...

{
  ...
  export BOLTZ_USE_MSA_SERVER=1
  export BOLTZ_USE_POTENTIALS=0
  export BOLTZ_FORCE_NO_TEMPLATE=1
  export BOLTZ_ALLOW_FALLBACK=1
  ...
  echo "fast_smoke_params: cpu no_template msa_server no_potentials recycling=1 sampling=5 affinity_sampling=5"
  boltz_timeout="${BOLTZ_FAST_SMOKE_TIMEOUT_SECONDS:-1800}"
