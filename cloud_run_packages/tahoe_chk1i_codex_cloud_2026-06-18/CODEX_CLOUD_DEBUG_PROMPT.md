...
- For a bounded full-scoring smoke test, run
...
- For chunked full scoring, set `TAHOE_INDEX_ONLY=0 TAHOE_MAX_FILES=ALL`,
  `TAHOE_READ_FILE_START=<offset>`, and `TAHOE_MAX_READ_FILES=<chunk_size>`.
